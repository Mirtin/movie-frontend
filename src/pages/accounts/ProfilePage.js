            ...
            <Box sx={{ display: 'flex', height: '91.9vh' }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', width: '40%', height: '100%', justifyContent: 'center', alignItems: 'center', gap: 5 }}>
                    <Box sx={{ display: 'flex', width: '90%', height: '40%', backgroundColor: '#B3C8CF', alignItems: 'center', justifyContent: 'space-evenly', borderRadius: '5%' }}>
                        <IconButtonComponent size={'100px'} image={cookies.get('avatar')} onClick={handleButtonClick} />
                        <input
                            type="file"
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', width: '60%', height: '100%'}}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", height: "48%", margin: 1 }}>
                        <Box sx={{display: 'flex'}}>
                            <StarIcon />
                            <Typography>Your Rated Movie</Typography>
                        </Box>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", height: "48%", margin: 1 }}>
                        <Box sx={{display: 'flex'}}>
                            <BookmarkIcon />
                            <Typography>Your Saved Movie</Typography>
                        </Box>
                        <Box sx={{display: "flex", height: "90%"}}>
